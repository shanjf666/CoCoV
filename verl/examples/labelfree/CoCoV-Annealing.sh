...
# ============================================================
# CoCoV-Annealing: Consistency-based Cooperative Verification
#                   with Annealing Training
# ============================================================
# Diversity-regularized PPO training with two-stage self-
# verification. Uses standard GRPO advantage estimator
# (contrast with CoCoV.sh which uses pass_grpo_penalized).
#
# Usage:
#   bash CoCoV-Annealing.sh [OPTIONS] [-- EXTRA_HYDRA_ARGS...]
#
# Options:
...
#
# Examples:
#   bash CoCoV-Annealing.sh
#   bash CoCoV-Annealing.sh --task AIME --backbone Qwen3-8B-Base
#   bash CoCoV-Annealing.sh --backbone /path/to/my/model
#   bash CoCoV-Annealing.sh --clip-high 0.30 --ent 0.003
#   bash CoCoV-Annealing.sh --temp 0.8 -- trainer.n_gpus_per_node=8
# ============================================================
